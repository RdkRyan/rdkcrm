        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Welcome to{' '}
              <span className="text-blue-600 dark:text-blue-400">RDK CRM</span>
            </h1>
       ...
       <div id="features" className="py-24 bg-white dark:bg-gray-800">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                         {/* Feature 1 */}
             <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl hover:shadow-lg transition-shadow duration-200">
             ...
             <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl hover:shadow-lg transition-shadow duration-200">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Advanced Reporting</h3>
               <p className="text-gray-600 dark:text-gray-300">
             ...
             <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl hover:shadow-lg transition-shadow duration-200">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Call Logging</h3>
               <p className="text-gray-600 dark:text-gray-300">
             ...
             <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl hover:shadow-lg transition-shadow duration-200">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Real-time Updates</h3>
               <p className="text-gray-600 dark:text-gray-300">
