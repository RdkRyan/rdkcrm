    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">You must be logged in to view call logs.</p>
          <a
            href="/"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Call Logs</h1>
              <p className="text-gray-600 dark:text-gray-300">View and manage call history</p>
            </div>
          ...
          {loading && (
            <div className="flex justify-center items-center py-12">
              ...
              <span className="ml-3 text-gray-600 dark:text-gray-300">Loading call logs...</span>
            </div>
          )}
          ...
          {!loading && callLogs.length === 0 && !error && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No call logs</h3>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">No call logs found in the system.</p>
            </div>
          )}
        </div>
      </div>
